...
public class registrationConfirmation {
	...
	protected static void sendRegistrationConfirmationEmail(HttpServletRequest request) {
		...
		if(request.getParameter("email") != null) {
			...
			try {
				msg.setContent("Thank you for registering. Please click to this  <a href='127.0.0.1:8080/csci4050-bookstore/accountActivation?userEmail=" + request.getParameter("email") + "'>link</a> to activate. If a link is not presented, please copy and paste the following link into your browser. 127.0.0.1:8080/csci4050-bookstore/accountActivation?userEmail=" + request.getParameter("email"),"text/html");
